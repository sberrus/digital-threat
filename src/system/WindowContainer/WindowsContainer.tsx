...
const WindowsContainer = () => {
	return (
		<Container fluid className="p-0" id="WindowsContainer" style={{ height: "95%", position: "relative" }}>
			<WindowBackgroundImageController />
			<WindowAppContainer appName={"Identification"} windowLayoutState="fullscreen">
				<IdentificationApp />
			</WindowAppContainer>
		</Container>
	);
